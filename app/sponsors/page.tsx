...
import { getSponsors, getSponsorImageUrl } from "@/lib/api" // Assuming this is the function to fetch sponsors from the database
...
export default async function Sponsors() {
  ...
  const currentSponsors = await getSponsors() // Fetch sponsors from the database
